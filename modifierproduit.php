...
<p style="max-width: 20%; margin-left: 70%;"><a href="vendeur.html" class="btn btn-primary btn-block">Retourner </a></p>
        ...
        <div class="container my-5">
            ...
            <form method="POST" enctype="multipart/form-data" id="edit-product-form" action="Controller/ProduitController.php?action=updateProduit&id=<?php echo $_GET['id']; ?>" class="p-4 bg-light rounded shadow">
                
                <!-- Nom du produit -->
                <div class="form-group">
                    <label for="product-name">Nom du Produit :</label>
                    <input type="text"name="nom" value="<?php echo htmlspecialchars($produit['nom']); ?>" id="product-name" class="form-control" placeholder="Entrez le nom du produit" required>
                </div>
        
                <!-- Prix -->
                <div class="form-group">
                    <label for="product-price">Prix (TND) :</label>
                    <input type="text" value="<?php echo htmlspecialchars($produit['prix']); ?>"	name="prix" id="product-price" class="form-control" placeholder="Entrez le prix" required>
                </div>
                ...
                <button type="submit" class="btn btn-primary btn-block" onclick="modifierProduit(event)">Modifier le Produit</button>
            </form>
        </div>
