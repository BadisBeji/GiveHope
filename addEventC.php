      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a href="donate.html" class="nav-link">Donation</a>
            </li>
            <li class="nav-item">
              <a href="Article.html" class="nav-link">Article</a>
            </li>
            <li class="nav-item active">
              <a href="display.php" class="nav-link">Event</a>
            </li>
            <li class="nav-item">
    ...
    <footer class="footer bg-dark text-white py-5 mt-5">
      <div class="container">
        ...
        <div class="row mt-4 pt-3 border-top">
          <div class="col-md-6">
            <p class="small mb-0">
              &copy; 2025 Give4You. Tous droits réservés.
            </p>
          </div>
          <div class="col-md-6">
